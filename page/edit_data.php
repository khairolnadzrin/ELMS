    ...
    ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="box-header">
                                    <h3 class="box-title">EDIT STAFF PROFILE</h3>
                                </div><!-- /.box-header -->
                            <div class="box box-primary">
                             
                                <form method="post" onsubmit='return validateMyForm()' action="edit_data.php?id=<?php echo  $_GET["id"]; ?>">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label>Staff ID :</label>
                                        <input type="text" class="form-control" id="staffID" name="staffID" placeholder="Enter ID" required value="<?php echo $_GET["id"]; ?>" style="text-transform:uppercase" />
                                    </div>
                                    <div class="form-group">
        ...
        $sql2="UPDATE $staff SET staff_id ='$staffID', staff_fname='$fname', staff_lname='$lname', staff_ic='$staffIc', staff_address='$address', staff_pnumber='$phoneNumber', staff_title='$position' WHERE staff_id='$staffID'";
            ...
            if(isset($_POST['delete']))
            {
                ...
                $sql3="DELETE FROM $staff WHERE staff_id='$staffID'";

                if($result3 = mysqli_query($conn, $sql3))
                {
                    echo '<script type="text/javascript">'; 
                    echo 'alert("User delete sucessfully");'; 
                    echo 'window.close()';
                    echo '</script>';
                }
                else
