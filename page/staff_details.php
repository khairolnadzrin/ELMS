                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active">
                            <a href="staff_data.php">
                                <i class="fa fa-th-list"></i> <span>Staff info</span>
                            </a>
                        </li>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <td><?php $name = $rows['staff_fname'] .' '. $rows['staff_lname'];
                                                echo $name;  ?></td>
                                                <td><?php echo $rows['staff_ic'] ?></td>
                                                <td><?php echo $rows['staff_pnumber'] ?></td>
                                                <td><?php echo $rows['staff_title'] ?></td>
                                                <td> <?php echo $rows['staff_address'] ?></td>
                                                <td><a href="javascript:popup3('edit_data.php?id=<?php echo $rows['staff_id']?>')">Edit</a></td>
                                            </tr>
